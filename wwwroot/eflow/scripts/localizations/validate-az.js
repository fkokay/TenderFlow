...
(function ($) {
    $.extend($.validator.messages, {
        ...
        maxval: $.validator.format("Zəhmət olmasa, {0} və ondan kiçik rəqəm daxil edin."),
        minval: $.validator.format("Zəhmət olmasa, {0} və ondan böyük rəqəm daxil edin"),
        defaultStr: $.validator.format("Sıfırdan başqa bir dəyər daxil edin.")
    });
}(jQuery));