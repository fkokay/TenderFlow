 ...
 */
 ...
 /*UTILS globals window, navigator, document, FormData, File, HTMLInputElement, XMLHttpRequest*/
...
qq.FineUploaderBasic.prototype = {
    ...
    _formatFileName: function(name){
        if (name.length > 33){
            name = this._options.text.filenameText + " " +  name.slice(0, 19) + '...' + name.slice(-13);
        }
        return this._options.text.filenameText + " " + name;
    },
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        fileTemplate: '<li>' +
            ...
            '<div class="qq-progress-bar-wrap">' +
