"use strict";
var KTDatatablesDataSourceAjaxServerCobm = function () {

    $('#divSelectedUserView').hide();

    var initTableCobm = function () {
        ...
        table.DataTable({
            ...
            ajax: {
                ...
                url: '/Partials/ProcessDataByType?type=3',
                data: {
        ...
        $('#SelectedProcessOrderID').bind('change', function (e) {
            ...
            localStorage.removeItem("_selectedProcessOrderID_comp_bm");
            localStorage.setItem("_selectedProcessOrderID_comp_bm", sortFilterText);
            ...
            $('#kt_table_4').dataTable().fnFilter(sortFilterText);
        });
...
jQuery(document).ready(function () {
    ...
    KTDatatablesDataSourceAjaxServerCobm.init();
    ...
    if (NetolojiFilter.HasFilterDataAtLocalStorage()) {
        ...
        var retrievedObject = localStorage.getItem("_selectedProcessOrderID_comp_bm");
