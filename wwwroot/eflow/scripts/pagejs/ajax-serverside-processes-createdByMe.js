...
var KTDatatablesDataSourceAjaxServerCbm_InitComplated = false;

var KTDatatablesDataSourceAjaxServerCbm = function () {

    $('#divSelectedUserView').hide();

    var initTableCmb = function () {
        ...
        table.DataTable({
            ...
            "fnInitComplete": function (settings) {
                ...
                KTDatatablesDataSourceAjaxServerCbm_InitComplated = true;
            },
            ...
            ajax: {
                ...
                url: '/Partials/ProcessDataByType?type=1',
                data: {
        ...
        $('#kt_table_2').on('error.dt', function (e, settings, techNote, message) {
            console.log('An error has been reported by DataTables: ', message);
        });

        $("#txtGeneralSearch").on('keypress', function (e) {
            if (e.which == 13 || e.keyCode == 13) {
                $('#kt_table_2').dataTable().fnFilter(this.value);
            }
        });
        ...
        $('#SelectedProcessOrderID').bind('change', function (e) {
            ...
            localStorage.removeItem("_selectedProcessOrderID_cbm");
            localStorage.setItem("_selectedProcessOrderID_cbm", sortFilterText);
            ...
            $('#kt_table_2').dataTable().fnFilter(sortFilterText);
        });
...
jQuery(document).ready(function () {
    ...
    KTDatatablesDataSourceAjaxServerCbm.init();
    ...
    if (NetolojiFilter.HasFilterDataAtLocalStorage()) {
        ...
        if (NetolojiFilter.HasReturnResultAtLocalStorage()) {
            ...
            $('#kt_table_2').dataTable().fnFilter('$');
        }
    }
    else {
        var retrievedObject = localStorage.getItem("_selectedProcessOrderID_cbm");
